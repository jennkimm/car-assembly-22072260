...
- [x] **[사용자 확인]** 각 Step 완료 후 기존 동작과 동일하게 작동하는지 수동 확인
- [x] **[사용자 확인]** `static int[] stack` 전역 상태 완전히 제거 확인
- [x] **[사용자 확인]** BUG-01 수정: 고장난 엔진 선택 시 Test가 FAIL 반환 확인
- [x] **[사용자 확인]** 출력 메시지(한국어)가 리팩토링 전과 동일한지 확인
